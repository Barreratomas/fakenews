...
from src.config import PROCESSED_DATA_DIR, RAW_DATA_DIR # Importamos configuración centralizada
...
def save_dataset(ds, name):
    # Usamos PROCESSED_DATA_DIR de config.py
    out_dir = os.path.join(PROCESSED_DATA_DIR, name)
